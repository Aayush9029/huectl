...
func (m Model) View() string {
	...
	b.WriteString("\n")
	b.WriteString(dimStyle.Render("j/k select  space toggle  o on  f off  +/- brightness  c color  r refresh  q quit"))
	b.WriteString("\n")
	return b.String()
}
...
func (m Model) openColorPicker() (tea.Model, tea.Cmd) {
	if len(m.lights) == 0 {
